...
Java_com_mattymatty_RegionalPathfinder_test_loadCNodes(
        JNIEnv *env,
...
extern "C" JNIEXPORT void JNICALL
Java_com_pathfinders_politomap_utility_Graph_loadCEdges(
        JNIEnv *env,
...
Java_com_pathfinders_politomap_utility_Graph_shortestCPath(
        JNIEnv *env,
